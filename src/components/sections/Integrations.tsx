      ...
      <div className="container mx-auto">
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-8">
          <div className="flex items-center justify-center p-6 bg-white rounded-lg shadow-md">
            <img src="/logos/hammertech-logo.png" alt="Hammertech" className="max-h-12" />
          </div>
          <div className="flex items-center justify-center p-6 bg-white rounded-lg shadow-md">
            <img src="/logos/safetyculture-logo.png" alt="SafetyCulture" className="max-h-12" />
          </div>
          <div className="flex items-center justify-center p-6 bg-white rounded-lg shadow-md">
            <img src="/logos/procore-logo.png" alt="Procore" className="max-h-24" />
          </div>
          <div className="flex items-center justify-center p-6 bg-white rounded-lg shadow-md">
            <img src="/logos/oracle-aconex-logo.png" alt="Oracle Aconex" className="max-h-12" />
          </div>
          <div className="flex items-center justify-center p-6 bg-white rounded-lg shadow-md">
            <img src="/logos/hsi-donesafe-logo.png" alt="Donesafe" className="max-h-12" />
          </div>
          <div className="flex items-center justify-center p-6 bg-white rounded-lg shadow-md">
